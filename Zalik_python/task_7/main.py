...
from Zalik.pyth.task_7.linked_list import LinkedList
from Zalik.pyth.task_7.validation import *
from Zalik.pyth.task_7.observer import *
from Zalik.pyth.task_7.context import Context
